    ...
    <div className="bg-[#050414] py-20 px-[5vw]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-5 justify-items-center">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="w-4 h-4 text-7xl flex items-center justify-center text-white border border-sky-400 rounded-md shadow-[0_0_10px_rgba(165,82,255,0.2)] hover:scale-105 transition-transform duration-300"
          >
            {skill.icon}
          </div>
        ))}
